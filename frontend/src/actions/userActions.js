...
export const register = (name, email, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`https://projet-final-backend.vercel.app/api/users`, { name, email, password }, config);
...
export const getUserDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`https://projet-final-backend.vercel.app/api/users/${id}`, config);
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`https://projet-final-backend.vercel.app/api/users/profile`, user, config);
...
export const addFavorite = (productId) => async (dispatch, getState) => {
    try {
        ...
        const response = await axios.put(`https://projet-final-backend.vercel.app/api/users/favorites/add`, { productId }, config);
...
export const removeFavorite = (productId) => async (dispatch, getState) => {
    try {
        ...
        await axios.put(`https://projet-final-backend.vercel.app/api/users/favorites/remove`, { productId }, config);
...
export const listFavorites = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get('https://projet-final-backend.vercel.app/api/users/favorites', config);
