...
export const listProducts = (keyword = '') => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`https://projet-final-backend.vercel.app/api/products?name=${keyword}`);
...
export const createProduct = (productData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`https://projet-final-backend.vercel.app/api/products`, productData, config);
